...
const SeatInfo = () => {
  ...
  return (
    ...
    <View style={styles.seatInfoBottom}>
    ...
    <StripeProvider publishableKey='pk_test_51JD3saSIVTXDPZ2W06cyAl4VvK2fJkkQdNV1q4iRuhPU2GWQ6ZxkVVsKRduIPF8ClgHz4294kOG45GanDSp1hUXI00bF4rdzmJ'>
      {!active && <Payment/>}
    </StripeProvider>
